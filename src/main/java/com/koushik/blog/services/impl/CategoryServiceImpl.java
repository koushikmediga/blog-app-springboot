...
import com.koushik.blog.services.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
	...
	public CategoryDto getCategory(Integer categoryId) {
		...
		return this.modelMapper.map(cat, CategoryDto.class); // changing to dto to return as response
	}
	...
	public List<CategoryDto> getCategories() {
		...
		// for each element in list converting it to categorydto to return it
